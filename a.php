                                ...
                                <div id="myModal" class="modal" style="display: block;"> <!--  included style="display: block;" in this modal if button is with in form tag else excluded it -->
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <table>
                                                <tr>
                                                    <td><b><p>STUDENT NUMBER:</p></b></td>
                                                    <td><b><p><?=$row['studentNumber']?></p></b></td>
                                                </tr>
                                                <tr>
                                                    <td><b><p>STATUS:</p></b></td>
                                                    <td><b><p><?=$row['studentType']?></p></b></td>
                                                </tr>  
                                                <tr>
                                                    <td>&nbsp;</td>
                                                    <td>&nbsp;</td>
                                            ...
                                            <table>
                                                <!-- <thead> -->
                                                    <th style=" padding-right:  140px;">Subject Code</th>
                                                    <th style=" padding-right:  200px;"> Subject Description</th>
                                                    <th style=" padding-right:  100px;">Units</th>
                                                    <th style=" padding-right:  100px;">Action</th>
                                                <!-- </thead> -->
                                                <?php
                                                    $studnum = $row['studentNumber'];
                                                    $subjects = "SELECT t1.studentNumber,lastname,subjectCode,subjectDescription,subjectUnits,studentType FROM tblaccounts as t1 left join tblstudents as t2 on t1.studentNumber = t2.studentNumber left join tblcoursedetails as t3 on t2.courseID = t3.courseID left join tblsubjects as t4 on t3.courseID = t4.courseID where t1.studentNumber = $studnum";              
                                                ...
                                                <tr>
                                                    <td><p><?=$rows['subjectCode']?></p></td>
                                                    <td><p><?=$rows['subjectDescription']?></p></td>
                                                    <td><p><?=$rows['subjectUnits']?></p></td>
  ...
  <select>
    ...
    <option value="2">Descending</option>
            ...
            <!-- PHP CODE TO FETCH DATA FROM ROWS-->
                <?php
                    $sql = "SELECT * FROM tblstudents as t1 left join tblaccounts as t2 on t1.studentNumber = t2.studentNumber WHERE statusID = '0'";
                    $result = $conn->query($sql);
                    if ($result->num_rows > 0) 
                    {
                        while($row = $result->fetch_assoc()) 
                                ...
                                <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" >
                                    ...
                                    <td>
                                        <p><!-- ?php 
                                            ...
                                            while($name_result = mysqli_fetch_array($sqlGetName)) {
                                            ?> -->
                                            <p><?php echo $row['lastname'].", ".$row['firstname']." ".$row['middlename']?></p>
                                            <?php
                                            // }
                                            ?>
                                        </p>
